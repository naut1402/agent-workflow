...
Chi tiết implementation cho i18n. Quy ước: [`docs/convention/i18n.md`](../../convention/i18n.md). Checklist: [`docs/checklist/i18n.md`](../../checklist/i18n.md). Kiến trúc frontend (ModeRegistry, plugin bootstrap) — xem cấp Component.
