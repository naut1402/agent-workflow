...
Chi tiết implementation cụ thể — tên file, hàm, bảng schema. Đây là cấp **thay đổi thường xuyên nhất**: khi sửa, đối chiếu lại với code thật thay vì tin nội dung cũ. Chỉ ghi phần **không tự giải thích được qua tên file** (quirk, giới hạn đã biết, thứ tự migration).
...
#### 4.1.1 Bootstrap — ModeRegistry & service container
...
#### 4.2.2 Entrypoint & shim (2 transport)
