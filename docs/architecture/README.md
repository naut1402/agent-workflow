...
| **2 · Container** | [`2-container/`](2-container/README.md) | Hệ thống triển khai thành những khối chạy độc lập nào? (kèm **Bất biến kiến trúc**) |
| **3 · Component** | [`3-component/`](3-component/README.md) | Bên trong một container, chia thành những khối trách nhiệm nào? |
| **4 · Code** | [`4-code/`](4-code/README.md) | Implementation cụ thể ra sao? (cấp thay đổi thường xuyên nhất) |
