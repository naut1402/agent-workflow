...
Tài liệu áp dụng quy ước này: [`docs/architecture/`](../architecture/README.md). Quy ước trình bày markdown dùng chung: [`ui-design-guideline.md`](../agent-rules/ui-design-guideline.md) §3.
