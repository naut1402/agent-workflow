// Project registry, filesystem browse, autoscan, GitHub tokens config.
// Consumed mainly by Settings + the project picker (dashboard shell), not
// owned by a single feature module — see design.md (E0004-02) §3.1.
