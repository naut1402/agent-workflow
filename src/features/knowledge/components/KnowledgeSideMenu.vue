...
<template>
  <div class="knowledge-side-menu">
    <!-- Icon button, không text (docs/convention/ui-buttons.md): 3 action của cả màn. -->
...
/* Chuỗi overflow (docs/convention/ui-overflow.md): mỗi nhóm có vùng cuộn RIÊNG, nên chuỗi
