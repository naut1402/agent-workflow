...
export default {
  ...
  pipeline: {
    ...
    resetConfirmBody: 'Xoá artifact của step này và cho phép chạy lại. Không thể hoàn tác.',
    resetConfirmCascadeBody: 'Các step sau {label} đã có artifact — chọn chỉ xoá step này hay xoá cả các step sau. Không thể hoàn tác.',
