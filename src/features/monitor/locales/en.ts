...
export default {
  ...
  pipeline: {
    ...
    resetConfirmBody: 'Rolls the pipeline back to "{label}" so it can run again. By default no documents are deleted — tick below to delete them.',
    resetConfirmDeleteWarning: '⚠ The following files will be PERMANENTLY DELETED: {files}',
    resetScopeToggle: 'Reset scope',
    resetScopeStep: 'This step only',
    resetScopeOnward: 'This step and every step after it',
    deleteScopeToggle: 'Document deletion scope',
    deleteScopeStep: 'This step\'s documents only',
    deleteScopeOnward: 'Documents of this step and every step after it',
    deleteScopeOnwardBlocked: 'Only available when the reset scope is "This step and every step after it".',
    resetSubmit: 'Reset',
