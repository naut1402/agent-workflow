...
export default {
  ...
  githubTokens: {
    ...
    desc: 'Thêm PAT cho từng repo private để tải issue khi tạo task. Ưu tiên token theo repo; nếu thiếu thì dùng biến môi trường GITHUB_TOKEN.',
    empty: 'Chưa có token nào.',
    repoPlaceholder: 'owner/repo hoặc https://github.com/owner/repo',
    tokenPlaceholder: 'ghp_… hoặc github_pat_…',
    add: 'Thêm',
    edit: 'Sửa',
    saveEdit: 'Cập nhật',
    cancelEdit: 'Huỷ',
    remove: 'Xoá token',
    tokenSet: 'Đã lưu token',
    saved: 'Đã lưu.',
    repoRequired: 'Nhập slug hoặc URL repo GitHub.',
    repoInvalid: 'Không nhận diện được repo — dùng owner/repo hoặc URL github.com.',
    tokenRequired: 'Nhập token GitHub.',
    loadError: 'Không tải được cấu hình token GitHub.',
  },
  notifications: {
    title: 'Thông báo',
