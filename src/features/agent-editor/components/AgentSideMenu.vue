...
/* Chuỗi overflow theo docs/architecture/4-code/ui-overflow.md: chỉ `.agent-side-groups` là lá mang
...
/* Cố ý KHÔNG khai `.agent-group::details-content`: chuỗi overflow đã dừng ở `.agent-side-groups`, không cần đi xuyên qua `<details>` (docs/architecture/4-code/ui-overflow.md). */
.agent-group > summary {
  display: flex;
  align-items: center;
  gap: 6px;
