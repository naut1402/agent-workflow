...
Quy ước hub: AGENTS.md. Chi tiết PR body: .claude/rules/git-pr.md (§8.1–§8.2).
Kiến trúc + cấu trúc thư mục: docs/architecture.md · feature map: .claude/rules/feature-architecture-guideline.md.
-->
...
<!-- .claude/rules/pr-todo-debt.md — CI Todo debt chỉ gate promote lên main. -->
...
- [ ] Tuân thủ `.claude/rules/coding-guideline.md` + `feature-architecture-guideline.md`
...
- [ ] **Git hygiene** (`.claude/rules/git-pr.md`): đã soát `git status` / `git diff --staged` — KHÔNG commit file ngoài phạm vi / generated / export / lockfile lạ
